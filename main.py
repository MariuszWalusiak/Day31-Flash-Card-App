...
def next_card():
    ...
    canvas.itemconfig(card_background, image=photo_image_front)
...
def flip_card():
    ...
    canvas.itemconfig(card_background, image=photo_image_back)
...
photo_image_back = PhotoImage(file="images/card_back.png")
card_background = canvas.create_image(400,263, image=photo_image_front)
